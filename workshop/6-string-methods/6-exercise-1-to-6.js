...
const arrAlternateRicks = alternateRicks.split(",");
...
console.log(arrAlternateRicks.length);
//
//
//
//
...
const charNumber = rickSaying.length - 3; /*we know that there are 3 spaces*/
...
console.log(`His real name is ${realGrandson}`);
//
//
//
//
